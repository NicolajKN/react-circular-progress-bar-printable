...
const Settings: React.FC<IFlatSettings> = (props) => {
  ...
  const handleValueCheck = (e: React.ChangeEvent<HTMLInputElement>): void => {
    ...
    if (e.target.checked) {
      valueSection.current?.classList.remove(
        "opacity-50",
        "pointer-events-none",
      );
    } else {
  ...
  const handleTextCheck = (e: React.ChangeEvent<HTMLInputElement>): void => {
    props.setFlatOptions((prev) => ({
      ...prev,
      text: e.target.checked ? "Lorem ipsum" : "",
    }));
    if (e.target.checked) {
      textSection.current?.classList.remove(
        "opacity-50",
        "pointer-events-none",
      );
    } else {
...
/>`;
  ...
  return (
    <div className="main-flat">
      ...
      >
        ...
        <div className="flex flex-col gap-3 relative">
          <label className="absolute left-0 -top-[23px] w-full text-center flex justify-center items-center">
            ...
            <span className="text-sm text-purple-500 font-semibold bg-white pr-3 pl-3">
              Value
            </span>
          </label>
          <div
            ...
            <div className="flex gap-2">
              ...
              <input
                ...
                onChange={(e) =>
                  props.setFlatOptions((prev) => ({
                    ...prev,
                    sign: { ...prev.sign, value: e.target.value },
                  }))
                }
              />
              <select
                ...
                onChange={(e) =>
                  props.setFlatOptions((prev) => ({
                    ...
                    sign: {
                      ...prev.sign,
                      position: e.target.value as SignPosition,
                    },
                  }))
                }
              >
              ...
              <div className="flex gap-2">
                ...
                <select
                  ...
                  onChange={(e) =>
                    props.setFlatOptions({
                      ...props.flatOptions,
                      valueFamily: e.target.value as FontFamily,
                    })
                  }
              ...
              <div className="flex gap-2">
                ...
                <input
                  ...
                  onChange={(e) =>
                    props.setFlatOptions({
                      ...props.flatOptions,
                      valueSize: parseInt(e.target.value),
                    })
                  }
              ...
              <div className="flex gap-2">
                ...
                <select
                  ...
                  onChange={(e) =>
                    props.setFlatOptions({
                      ...props.flatOptions,
                      valueWeight: e.target.value as FontWeight,
                    })
                  }
        ...
        <div className="flex flex-col gap-3 relative">
          <label className="absolute left-0 -top-[23px] w-full text-center flex justify-center items-center">
            ...
            <span className="text-purple-500 font-semibold bg-white pr-3 pl-3">
              Text
            </span>
          </label>
          <div className="flex gap-2">
              ...
              <div className="flex gap-2">
                ...
                <select
                  ...
                  onChange={(e) =>
                    props.setFlatOptions({
                      ...props.flatOptions,
                      textFamily: e.target.value as FontFamily,
                    })
                  }
                  className="outline-none text-sm text-gray-700 border rounded-lg"
                >
              ...
              <div className="flex gap-2">
                ...
                <select
                  ...
                  onChange={(e) =>
                    props.setFlatOptions({
                      ...props.flatOptions,
                      textWeight: e.target.value as FontWeight,
                    })
                  }
            ...
            <div className="flex flex-col w-fit justify-center items-center basis-1/5">
              ...
              <input
                ...
                onChange={(e) =>
                  props.setFlatOptions((prev) => ({
                    ...prev,
                    bgColor: { ...prev.bgColor, value: e.target.value },
                  }))
                }
            ...
            <div className="flex flex-col w-fit justify-center items-center basis-1/5">
              ...
              <input
                ...
                onChange={(e) =>
                  props.setFlatOptions({
                    ...props.flatOptions,
                    miniCircleColor: e.target.value,
                  })
                }
              />
            </div>
            ...
            <div className="flex gap-2">
              <input
                ...
                onChange={(e) =>
                  props.setFlatOptions((prev) => ({
                    ...prev,
                    showMiniCircle: e.target.checked,
                  }))
                }
              />
            ...
            <div className="flex gap-2">
              ...
              <input
                ...
                onChange={(e) =>
                  props.setFlatOptions((prev) => ({
                    ...prev,
                    miniCircleSize: Number(e.target.value),
                  }))
                }
              />
            </div>
          ...
          <div className="flex gap-2">
            <input
              ...
              onChange={(e) =>
                props.setFlatOptions((prev) => ({
                  ...prev,
                  valueAnimation: e.target.checked,
                }))
              }
            />
          ...
          <div className="flex gap-2">
            <input
              ...
              onChange={(e) =>
                props.setFlatOptions((prev) => ({
                  ...prev,
                  intersectionEnabled: e.target.checked,
                }))
              }
            />
            ...
            <input
              ...
              onChange={(e) =>
                props.setFlatOptions((prev) => ({
                  ...
                  bgColor: {
                    ...prev.bgColor,
                    transparency: e.target.value.toString(),
                  },
                }))
              }
            ...
            <div>
              <input
                ...
                onChange={(e) =>
                  props.setFlatOptions((prev) => ({
                    ...prev,
                    range: { ...prev.range, from: parseInt(e.target.value) },
                  }))
                }
              ...
              <input
                ...
                onChange={(e) =>
                  props.setFlatOptions((prev) => ({
                    ...prev,
                    range: { ...prev.range, to: parseInt(e.target.value) },
                  }))
                }
                className="border rounded-lg w-20 pl-2"
              />
          ...
          <div className="flex gap-2">
            ...
            <select
              ...
              onChange={(e) =>
                props.setFlatOptions((prev) => ({
                  ...prev,
                  shape: e.target.value as FlatShape,
                }))
              }
            >
          ...
          <div className="flex gap-2">
            ...
            <select
              ...
              onChange={(e) =>
                props.setFlatOptions((prev) => ({
                  ...prev,
                  strokeLinecap: e.target.value as StrokeLineCap,
                }))
              }
            >
          ...
          <div className="flex gap-2">
            ...
            <input
              ...
              onChange={(e) =>
                props.setFlatOptions({
                  ...props.flatOptions,
                  loadingTime: parseInt(e.target.value),
                })
              }
              className="border rounded-lg outline-none pl-2 focus:border-400 w-20 "
            />
      ...
      <div
        ref={codeSection}
        className="settings back-flat bg-white border drop-shadow-lg rounded-md transition-all duration-[800ms] overflow-hidden"
      >
        <div
          ref={copyBg}
          onClick={copy}
        ...
        >
          <span className="text-white font-mono font-semibold text-3xl cursor-default">
            Copy
          </span>
        </div>
        <div>
